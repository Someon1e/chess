...
impl MoveGenerator {
    ...
    fn gen_king(&self, moves: &mut Vec<Move>) {
        ...
        while !king_moves.is_empty() {
            ...
            moves.push(Move::new(self.friendly_king_square, move_to));
        }
